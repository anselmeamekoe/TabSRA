...
for i, row in df.iterrows():
    ...
    try:
        ...
        pass
    if use_gpu:
        OAR_COMMAND = """oarsub "module load conda;conda activate TabBenchmark;wandb agent {}/{}/{}"  -l gpu=1,walltime=2:00:00 -p "not cluster='graphite' AND not cluster='grimani' AND not cluster='gruss'" -q {}"""
        ...
        OAR_COMMAND = """oarsub "module load conda;conda activate TabBenchmark;wandb agent {}/{}/{}" 
        -l core=32, walltime=2:00:00 -I"""
